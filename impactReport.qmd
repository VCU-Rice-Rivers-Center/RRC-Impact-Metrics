...
knitr::kable(student_reservation_facility_usage,
             caption = "Proportion of Facility Usage by Reservations with VCU Students",
             format = "simple",
...
##### Departments and Organizations bringing VCU Students to RRC

```{r}

student_orgs <- unique(student_reservations$`Organization's Name`)
