...
### Count of VCU students reserving facilities by year
```{r}
students_per_year_output <- students_per_year %>%
  mutate(estimate = paste0(students_per_year_low_estimate, " - ", students_per_year_high_estimate)) %>%
  select(year, estimate)
  

knitr::kable(students_per_year_output, 
             col.names = c("Year", "Estimated Count of VCU Students"))
```
